...
document.getElementById('inputKM').addEventListener('input', function (e) {
    ...
    document.getElementById('inputMI').value = (kilometers * 1.60934).toFixed(10);
});
document.getElementById('inputMM').addEventListener('input', function (e) {
    var milimeters = e.target.value;
    console.log(milimeters);
    document.getElementById('inputCm').value = (milimeters * 0.1).toFixed(10);
    document.getElementById('inputIn').value = (milimeters * 0.0393701).toFixed(10);
    document.getElementById('inputKM').value = (milimeters * 0.000001).toFixed(10);
    document.getElementById('inputM').value = (milimeters * 0.001).toFixed(10);
    document.getElementById('inputY').value = (milimeters * 0.00109361).toFixed(10);
    document.getElementById('inputMI').value = (milimeters / 1609340).toFixed(10);
});
...
var firebaseConfig = {
    apiKey: "AIzaSyBZaKkNNNOaUVV1dMqX-a1VZAdd2L3odu8",
    authDomain: "distanceconverters.firebaseapp.com",
    projectId: "distanceconverters",
    storageBucket: "distanceconverters.appspot.com",
    messagingSenderId: "72342542723",
    appId: "1:72342542723:web:f2a400826c223f530cfeb6",
    measurementId: "G-XZSFSKWR6J"
};
